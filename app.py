...
DEFAULT_PARAMS: dict = {
    ...
    "macd_dev_pct_min": -50.0,
    "macd_dev_pct_max": 50.0,
...
def _cache_key(params: dict) -> tuple:
    ...
    macd_dev = (round(float(params["macd_dev_pct_min"]), 4), round(float(params["macd_dev_pct_max"]), 4)) if params["apply_macd_dev_pct"] else ("off",)
    ...
    return ("v14", as_of, price, price_dev, ema_dev, macd, macd_dev, turnover, pct_change, high, rsi, rsi_dev, rvol, avg_vol, lists)
...
def _parse_params() -> dict:
    ...
    return {
        ...
        "macd_dev_pct_min": _flt("macd_dev_pct_min", -50.0),
        "macd_dev_pct_max": _flt("macd_dev_pct_max", 50.0),
        ...
        "apply_macd_dev_pct": _parse_bool("apply_macd_dev_pct", False),
...
def _api_screen_impl():
    ...
    hits = screener.run_screen(
        ...
        macd_dev_pct_min=params["macd_dev_pct_min"],
        macd_dev_pct_max=params["macd_dev_pct_max"],
        ...
        apply_macd_dev_pct=params["apply_macd_dev_pct"],
