...
A ticker passes when **all six** are true on the close being evaluated
...
4. **Price deviation vs EMA(21) ∈ [-5%, +5%]** —
   `(close − EMA21) / EMA21`.
5. **10-day relative volume > 0.5** — that day's volume / mean of the prior
   10 days.
6. **Price between $1 and $1000** — based on that close.
